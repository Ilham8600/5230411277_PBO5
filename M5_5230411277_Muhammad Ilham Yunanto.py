...
def add_Isong(Isongs):
    try:
        judul = input("Masukan Judul Lagu: ")
        if any(Isong.judul == judul for Isong in Isongs):
            print("Judul lagu sudah ada, lagu gagal ditambahkan.")
            return
        
        penyanyi = input("Masukan Nama Penyanyi: ")
        genre = input("Masukan Genre Musik: ")
        new_isong = Indonesia(judul, penyanyi, genre)
        Isongs.append(new_isong)
        print("Lagu berhasil ditambahkan.")
    except ValueError:
        print("Input tidak Valid")

def add_Jsong(Jsongs):
    try:
        judul = input("Masukan Judul Lagu: ")
        if any(Jsong.judul == judul for Jsong in Jsongs):
            print("Judul lagu sudah ada, lagu gagal ditambahkan.")
            return
        
        penyanyi = input("Masukan Nama Penyanyi: ")
        genre = input("Masukan Genre Musik: ")
        new_jsong = Japanese(judul, penyanyi, genre)
        Jsongs.append(new_jsong)
        print("Lagu berhasil ditambahkan.")
    except ValueError:
        print("Input tidak Valid")
